...
mv $SAVEPATH/$PFX.Analysis/$PFX.fusioncatcher/star-fusion.fusion_predictions.tsv $SAVEPATH/$PFX.Analysis/$PFX.star-fusion_predictions.tsv
...
#mv $SAVEPATH/$PFX.Analysis/fusion_inspector_out $SAVEPATH/$PFX.Analysis/$PFX.final_folder/$PFX.fusion_inspector_out/
...
#mv $SAVEPATH/$PFX.Analysis/$PFX.logs $SAVEPATH/$PFX.Analysis/$PFX.to_be_deleted
